            ...
            <motion.div key="home" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="grid lg:grid-cols-12 gap-8 py-6">
              <div className="lg:col-span-8 space-y-8">
                <div className="relative overflow-hidden w-full h-80 bg-gradient-to-br from-red-600 to-rose-950 rounded-[3rem] p-12 flex flex-col justify-center shadow-2xl border-b-8 border-black/40">
                    <h1 className="text-7xl font-black mb-2 uppercase italic tracking-tighter text-white drop-shadow-2xl leading-none text-center">SWEET WINS</h1>
                    <div className="bg-white/10 w-fit px-6 py-2 rounded-full border border-white/20 backdrop-blur-md mb-4 mx-auto"><p className="text-white font-black text-xs uppercase tracking-widest animate-pulse">🎁 5 INVITES = 5 MILLION CANDY</p></div>
